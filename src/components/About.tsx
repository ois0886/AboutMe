        ...
        <div className={styles.infoArea}>
          ...
          <div className={styles.infoBlock}>
            ...
            <ul className={styles.introList}>
              <li><strong className={styles.emphasis}>Android/Kotlin</strong>을 중심으로 사용자 경험과 유지보수성을 고민해 왔고, <strong className={styles.emphasis}>Backend Engineering</strong>까지 확장해 클라이언트-서버 흐름을 함께 이해하려는 개발자입니다.</li>
