...
internal class LoginViewModel @Inject constructor(
  ...
  },
  {
    ...
    features: [
      ...
      '주문 생성, 주문 상세 조회, 최근 1개월/6개월 주문 내역 조회 API',
    ...
    problemSolvings: [
      {
        ...
        implementation: [
          {
            description:
              '주문 생성 서비스에서 주문 row를 먼저 저장하고, 생성된 주문 id를 상세 주문에 연결함. 이후 상세 주문 수량을 기준으로 상품 주문 수와 스탬프를 함께 갱신해 주문 도메인의 후속 상태를 한곳에서 관리함.',
            language: 'java',
            code: `@Override
@Transactional
